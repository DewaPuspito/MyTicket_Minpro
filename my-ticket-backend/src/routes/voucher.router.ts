...
export class VoucherRouter {
  ...
  private routes(): void {
    ...
    this.router.post('/event/:eventId/voucher', AuthenticationMiddleware.verifyToken, AuthorizationMiddleware.allowRoles(['EVENT_ORGANIZER']), ValidationMiddleware.validate(voucherSchema), this.voucherController.create.bind(this.voucherController))
